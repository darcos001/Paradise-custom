...
if (!contratExiste) {
  const contratParDefaut = `CONTRAT DE TRAVAIL — PARADIES CUSTOM

Entre Paradies Custom, ci-après désigné "l'employeur", et l'employé signataire, ci-après désigné "l'employé", il est convenu ce qui suit :

Article 1 — Fonction
L'employé est engagé en tant que mécanicien au sein du garage Paradies Custom, selon le grade qui lui est attribué.
...
Article 5 — Conduite
L'employé s'engage à respecter les autres membres de l'équipe et les clients, et à représenter le garage Paradies Custom de manière professionnelle.

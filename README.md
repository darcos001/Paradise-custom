# Paradies Custom — Outil de gestion / comptabilité
...
```
cd chemin/vers/paradies-custom
```
...
Serveur Paradies Custom démarré sur le port 3001
```
...
```
cd chemin/vers/paradies-custom/client
npm install
npm run dev
```
...
4. Tu obtiens une adresse en ligne (ex: `paradies-custom.up.railway.app`).
